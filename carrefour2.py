...
road_list = [{"id": 1, "type": "road", "start": (-60, 440), "end": (670, 440),  # routes de gauche
             ...
             {"id": 14, "type": "road", "start": (670, 440), "end": (770, 440), "with_arrows": False},  # routes du carrefour
             {"id": 16, "type": "arcroad", "start": 1, "end": 6},
             {"id": 18, "type": "arcroad", "start": 1, "end": 8},

             {"id": 32, "type": "road", "start": (770, 400), "end": (670, 400), "with_arrows": False},
             ...
             {"id": 58, "type": "road", "start": (700, 370), "end": (700, 470), "with_arrows": False},

             {"id": 72, "type": "arcroad", "start": 7, "end": 2},
             {"id": 74, "type": "arcroad", "start": 7, "end": 4},
             {"id": 76, "type": "road", "start": (740, 470), "end": (740, 370), "with_arrows": False}]
